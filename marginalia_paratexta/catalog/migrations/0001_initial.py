# Generated by Django 3.2.8 on 2023-11-01 17:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('original_title', models.CharField(blank=True, max_length=10000, null=True, verbose_name='Título original')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Movie', 'Movie'), ('TVSerie', 'Tvserie'), ('Theatre', 'Theatre'), ('Music', 'Music'), ('Comic', 'Comic'), ('Novel', 'Novel'), ('Videogame', 'Videogame'), ('Boardgame', 'Boardgame')], max_length=10000)),
            ],
            options={
                'verbose_name': 'Genero',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location', models.CharField(max_length=10000, verbose_name='Lugar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('videoclip', models.CharField(max_length=10000, verbose_name='Enlace al videoclip')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=10000, verbose_name='Titulo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=10000, null=True, verbose_name='Título')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(max_length=10000, verbose_name='ISBN')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('declarations', models.TextField(blank=True, null=True, verbose_name='Declaraciones autorizadas')),
                ('criticism', models.TextField(blank=True, null=True, verbose_name='Críticas')),
                ('press_articles', models.TextField(blank=True, null=True, verbose_name='Artículos de prensa')),
                ('social_networks', models.TextField(blank=True, null=True, verbose_name='Social networks')),
                ('blogs', models.TextField(blank=True, null=True, verbose_name='Blogs')),
                ('fandoms', models.TextField(blank=True, null=True, verbose_name='Fandoms')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='product_metatext', to='catalog.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('info', models.CharField(max_length=10000, verbose_name='Información del nudo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fuentes_clasicas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hipotext_classic_sources', to='catalog.reference')),
                ('fuentes_documentales', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hipotext_documentary_sources', to='catalog.reference')),
                ('otras_fuentes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hipotext_other_sources', to='catalog.reference')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='product_hipotext', to='catalog.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.CharField(blank=True, max_length=10000, null=True, verbose_name='Link de la imagen')),
                ('videoclip', models.CharField(max_length=10000, verbose_name='Video del trailer')),
                ('description', models.TextField(verbose_name='Descripción')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('collection_name', models.CharField(max_length=10000, verbose_name='Nombre de la colección')),
                ('year', models.IntegerField(choices=[(1930, 1930), (1931, 1931), (1932, 1932), (1933, 1933), (1934, 1934), (1935, 1935), (1936, 1936), (1937, 1937), (1938, 1938), (1939, 1939), (1940, 1940), (1941, 1941), (1942, 1942), (1943, 1943), (1944, 1944), (1945, 1945), (1946, 1946), (1947, 1947), (1948, 1948), (1949, 1949), (1950, 1950), (1951, 1951), (1952, 1952), (1953, 1953), (1954, 1954), (1955, 1955), (1956, 1956), (1957, 1957), (1958, 1958), (1959, 1959), (1960, 1960), (1961, 1961), (1962, 1962), (1963, 1963), (1964, 1964), (1965, 1965), (1966, 1966), (1967, 1967), (1968, 1968), (1969, 1969), (1970, 1970), (1971, 1971), (1972, 1972), (1973, 1973), (1974, 1974), (1975, 1975), (1976, 1976), (1977, 1977), (1978, 1978), (1979, 1979), (1980, 1980), (1981, 1981), (1982, 1982), (1983, 1983), (1984, 1984), (1985, 1985), (1986, 1986), (1987, 1987), (1988, 1988), (1989, 1989), (1990, 1990), (1991, 1991), (1992, 1992), (1993, 1993), (1994, 1994), (1995, 1995), (1996, 1996), (1997, 1997), (1998, 1998), (1999, 1999), (2000, 2000), (2001, 2001), (2002, 2002), (2003, 2003), (2004, 2004), (2005, 2005), (2006, 2006), (2007, 2007), (2008, 2008), (2009, 2009), (2010, 2010), (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023)], default=2023, verbose_name='Año')),
                ('editorial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='editorial_collection', to='catalog.editorial')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.IntegerField(choices=[(1930, 1930), (1931, 1931), (1932, 1932), (1933, 1933), (1934, 1934), (1935, 1935), (1936, 1936), (1937, 1937), (1938, 1938), (1939, 1939), (1940, 1940), (1941, 1941), (1942, 1942), (1943, 1943), (1944, 1944), (1945, 1945), (1946, 1946), (1947, 1947), (1948, 1948), (1949, 1949), (1950, 1950), (1951, 1951), (1952, 1952), (1953, 1953), (1954, 1954), (1955, 1955), (1956, 1956), (1957, 1957), (1958, 1958), (1959, 1959), (1960, 1960), (1961, 1961), (1962, 1962), (1963, 1963), (1964, 1964), (1965, 1965), (1966, 1966), (1967, 1967), (1968, 1968), (1969, 1969), (1970, 1970), (1971, 1971), (1972, 1972), (1973, 1973), (1974, 1974), (1975, 1975), (1976, 1976), (1977, 1977), (1978, 1978), (1979, 1979), (1980, 1980), (1981, 1981), (1982, 1982), (1983, 1983), (1984, 1984), (1985, 1985), (1986, 1986), (1987, 1987), (1988, 1988), (1989, 1989), (1990, 1990), (1991, 1991), (1992, 1992), (1993, 1993), (1994, 1994), (1995, 1995), (1996, 1996), (1997, 1997), (1998, 1998), (1999, 1999), (2000, 2000), (2001, 2001), (2002, 2002), (2003, 2003), (2004, 2004), (2005, 2005), (2006, 2006), (2007, 2007), (2008, 2008), (2009, 2009), (2010, 2010), (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016), (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023)], default=2023, verbose_name='Año')),
                ('institution_name', models.CharField(max_length=10000, null=True, verbose_name='Nombre de la institucion')),
                ('text', models.CharField(max_length=10000, null=True, verbose_name='Información del premio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estreno', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.theaterdebut')),
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Theatre'}, to='catalog.Genre')),
                ('idioma_original', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.language')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('artistic_direction', models.TextField(verbose_name='Dirección artística')),
                ('producer', models.TextField(verbose_name='Producción')),
                ('cast', models.TextField(verbose_name='Reparto')),
                ('location', models.CharField(max_length=10000, verbose_name='Lugar')),
                ('theatre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theatre_staging', to='catalog.theatre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mediacreation_other_countriues_debut', to='catalog.mediacreation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Music'}, to='catalog.Genre')),
                ('idioma_original', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.language')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theatre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='theatre_images', to='catalog.theatre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_number', models.IntegerField(null=True, verbose_name='Número de entregas')),
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Videogame'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'TVSerie'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Novel'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Movie'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Comic'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('design', models.TextField(blank=True, null=True, verbose_name='Diseño')),
                ('genero', models.ManyToManyField(limit_choices_to={'type': 'Boardgame'}, to='catalog.Genre')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
